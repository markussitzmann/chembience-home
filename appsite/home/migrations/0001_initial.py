    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('headline', models.CharField(blank=True, max_length=255, null=True)),
                ('text', models.TextField(blank=True, help_text='Text to describe the page')),
                ('lightbox_button', models.BooleanField(default=True, verbose_name='Lightbox Button')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('headline', models.CharField(blank=True, max_length=255, null=True)),
                ('introduction', models.TextField(blank=True, help_text='Text to describe the page')),
                ('styling_options', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='home.GalleryIndexStyling')),
            ],
            options={
                'abstract': False,
            },
