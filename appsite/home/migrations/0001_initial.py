# Generated by Django 2.2.1 on 2019-05-16 22:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('style', models.CharField(choices=[('style1', 'No. 1'), ('style2', 'No. 2'), ('style3', 'No. 3'), ('style4', 'No. 4'), ('style5', 'No. 5'), ('style6', 'No. 6'), ('style7', 'No. 7')], default='No. 1', max_length=25)),
                ...
                ('color', models.CharField(blank=True, choices=[('invert', 'invert'), ('color0', 'color0'), ('color1', 'color1'), ('color2', 'color2'), ('color3', 'color3'), ('color4', 'color4'), ('color5', 'color5'), ('color6', 'color6'), ('color7', 'color7')], default='color0', max_length=25, null=True)),
                ('image_position', models.CharField(blank=True, choices=[('image-position-left', 'left'), ('image-position-center', 'center'), ('image-position-right', 'right')], max_length=25, null=True)),
                ('onload_fade', models.CharField(blank=True, choices=[('onload-content-fade-up', 'content fade up'), ('onload-content-fade-down', 'content fade down'), ('onload-content-fade-left', 'content fade left'), ('onload-content-fade-right', 'content fade right'), ('onload-content-fade-in', 'content fade in'), ('onload-image-fade-in', 'image fade in')], max_length=25, null=True)),
                ...
                ('color_choices', models.CharField(blank=True, choices=[('invert', 'invert'), ('color0', 'color0'), ('color1', 'color1'), ('color2', 'color2'), ('color3', 'color3'), ('color4', 'color4'), ('color5', 'color5'), ('color6', 'color6'), ('color7', 'color7')], max_length=25, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('options', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='home.StyleOptions')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('button_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='home.ActionButtonGroup')),
                ('image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailimages.Image')),
                ('options', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='home.StyleOptions')),
            ],
            options={
