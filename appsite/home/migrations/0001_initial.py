# Generated by Django 2.2.4 on 2019-08-09 23:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ContentOrientationAndAlignmentOptions',
            fields=[
                ('oa_id', models.AutoField(primary_key=True, serialize=False)),
                ('orientation', models.CharField(choices=[('orient-left', 'left'), ('orient-center', 'center'), ('orient-right', 'right')], default='orient-left', max_length=30, verbose_name='Content to image orientation')),
                ('alignment', models.CharField(blank=True, choices=[('content-align-left', 'left'), ('content-align-center', 'center'), ('content-align-right', 'right')], default='content-align-left', max_length=30, null=True, verbose_name='Content alignment')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_position', models.CharField(blank=True, choices=[('image-position-left', 'left'), ('image-position-center', 'center'), ('image-position-right', 'right')], max_length=30, null=True, verbose_name='Image Position')),
            ],
        ),
        migrations.CreateModel(
            name='ItemIndexPage',
        ...
        migrations.CreateModel(
            name='OnloadFadeOptions',
            fields=[
                ('onload_fade_id', models.AutoField(primary_key=True, serialize=False)),
                ('onload_content_fade', models.CharField(choices=[(None, 'none'), ('onload-content-fade-up', 'Up'), ('onload-content-fade-down', 'Down'), ('onload-content-fade-left', 'Left'), ('onload-content-fade-right', 'Right'), ('onload-content-fade-in', 'In')], default=None, max_length=30, verbose_name='Content Fade')),
                ('onload_image_fade', models.CharField(choices=[(None, 'none'), ('onload-image-fade-up', 'Up'), ('onload-image-fade-down', 'Down'), ('onload-image-fade-left', 'Left'), ('onload-image-fade-right', 'Right'), ('onload-image-fade-in', 'In')], default=None, max_length=30, verbose_name='Image Fade')),
            ],
        ),
        migrations.CreateModel(
            name='OnscrollFadeOptions',
            fields=[
                ('onscroll_content_fade_id', models.AutoField(primary_key=True, serialize=False)),
                ('onscroll_content_fade', models.CharField(choices=[(None, 'none'), ('onscroll-content-fade-up', 'Up'), ('onscroll-content-fade-down', 'Down'), ('onscroll-content-fade-left', 'Left'), ('onscroll-content-fade-right', 'Right'), ('onscroll-content-fade-in', 'In')], default=None, max_length=30, verbose_name='Content Fade')),
                ('onscroll_image_fade', models.CharField(choices=[(None, 'none'), ('onscroll-image-fade-up', 'Up'), ('onscroll-image-fade-down', 'Down'), ('onscroll-image-fade-left', 'Left'), ('onscroll-image-fade-right', 'Right'), ('onscroll-image-fade-in', 'In')], default=None, max_length=30, verbose_name='Image Fade')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='BannerStyling',
            fields=[
                ('onscrollfadeoptions_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, to='home.OnscrollFadeOptions')),
                ('onloadfadeoptions_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, to='home.OnloadFadeOptions')),
                ...
                ('contentorientationandalignmentoptions_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, to='home.ContentOrientationAndAlignmentOptions')),
            ...
            bases=('home.stylingbase', 'home.styleoptions', 'home.coloroptions', 'home.contentorientationandalignmentoptions', 'home.imagepositionoptions', 'home.onloadfadeoptions', 'home.onscrollfadeoptions'),
        ),
        migrations.CreateModel(
            name='GalleryStyling',
            fields=[
            ...
            bases=('home.stylingbase', 'home.sizeoptions'),
        ),
        migrations.CreateModel(
            name='StylingOptions',
            fields=[
                ('stylingbase_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='home.StylingBase')),
                ('orientation', models.CharField(choices=[('orient-left', 'left'), ('orient-center', 'center'), ('orient-right', 'right')], default='orient-right', max_length=30)),
